...
export const siteInfoMigration = sqliteTable("site_info", {
...
export async function addIsActiveColumn() {
  // For fresh databases, drizzle-kit push handles this automatically.
  // This function is available for manual migration if needed.
  return null;
}
